using ClassLibrary.Redis.Models.Cache;
...
namespace ClassLibrary.Redis
{
    public class RedisUSSD
    {
        ...
        {
            _redis = ConnectionMultiplexer.Connect("172.29.54.125:6379,password=Rd!8525002");
        ...
        public static void FirtTimeOrder(VarCacheTrans cacheMem)
        {
            ...
            Boolean isDeleted = db.KeyDelete(cacheMem.TransID);

            cacheMem.MenuId = cacheMem.Input.Replace("#", ""); ;
        ...
        public static VarCacheTrans QueryNode(VarCacheTrans cacheMem)
        {
